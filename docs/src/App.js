	...
	render() {
		return (
			<div id="home">
				...
				<section id="card" className="padding-top-is-x-large padding-bottom-is-x-large">
					<div className="container">
						<article className="article">
							<div className="heading">
								<h3 className="font-is-bold">Card</h3>
								<p>Culpa culpa deserunt magna nostrud sunt adipisicing cillum commodo dolore cupidatat nostrud veniam. Commodo id nulla consectetur aliqua aute. Fugiat irure consectetur cillum pariatur laboris est.</p>
							</div>
							<div className="row">
