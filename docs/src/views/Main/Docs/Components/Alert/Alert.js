...
const Alert = props => {
  return (
    <article id="alert-docs" className="DocsArticle">
      <section className="DocsArticle-intro">
        <header className="DocsArticle-heading">
          <h2 className="DocsArticle-title">Alerts</h2>
          <h5 className="DocsArticle-subtitle">
            Display non-interuptive and dismissable feedback message to your
            users.
          </h5>
        </header>
      </section>
      <section id="overview" className="DocsArticle-section">
        ...
        <p>
          An alert is usually consisted of{' '}
          <span className="u-FontWeight-semibold">a text element</span> and{' '}
          <span className="u-FontWeight-semibold">user actions.</span>
        </p>
        <Preview>
          <PreviewDisplay>
            <div className="Alert">
      ...
      <section id="themes" className="DocsArticle-section">
        ...
        <p>
          Alerts come with different <a href="">themes</a> that can be used
          accordingly in different contexts.
        </p>
        <ul>
          <li>
            {' '}
      ...
      <section id="extras" className="DocsArticle-section">
        <header className="Heading">
          <h4 className="Title">Icons</h4>
        </header>
        <p>
          You can use icons to better convey the message you want to tell your
          users.
        </p>
        <Preview>
          <PreviewDisplay>
            <div className="AlertShowcase">
              <div className="Alert Alert--warning u-MarginBottom">
                <div className="Alert-icon">
                  <i className="fas fa-exclamation-triangle" />
                </div>
                <div className="Alert-text">
                  This alert contains a warning message.
                </div>
              </div>
              <div className="Alert Alert--success">
                <div className="Alert-icon">
                ...
                <div className="Alert-text">
                  This alert contains a success message.
                </div>
              </div>
            </div>
          </PreviewDisplay>
        ...
        <p>
          It's always a good idea to make an alert dismissable by providing a
          close button.
        </p>
        <Preview>
          <PreviewDisplay>
            <div className="Alert Alert--warning">
              ...
              <div className="Alert-icon">
                <i className="Icon fas fa-times fa-lg" />
              </div>
            </div>
          </PreviewDisplay>
          <PreviewHighlight lang="html">
